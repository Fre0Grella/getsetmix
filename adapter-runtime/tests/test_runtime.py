...
class FakeAdapter:
	...
	async def download(self, source_url: str, output_format: str, job_id: str, staging_dir: str) -> DownloadResult:
		if self._fail_download:
			raise ValueError("adapter failed")
		return DownloadResult(audio_path="C:\\cache\\track.mp3", cover_path="C:\\cache\\cover.jpg")
